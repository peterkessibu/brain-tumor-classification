...
if uploaded_file is not None or st.session_state.selected_image is not None:
    ...
    saliency_map = generate_saliency_map(classification_model, img_array, class_index, img_size, uploaded_file if uploaded_file is not None else selected_sample,
